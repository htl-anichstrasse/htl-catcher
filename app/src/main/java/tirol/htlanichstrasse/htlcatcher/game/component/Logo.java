...
@Getter
@Setter
public abstract class Logo extends ViewPoint {
    /**
    ...
    /**
     * Called whenever this logo collides with the cursor
     */
    public abstract void onCollided();

    /**
     * Override with used bitmap for logo
     *
     * @param context the view context
     * @return the bitmap used for this logo
     */
    public abstract Bitmap getLogoBitmap(final Context context);
